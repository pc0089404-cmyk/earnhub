            ...
            <>
              ...
              {activeTab === 'admin' && (
                (user.inviteCode === 'MBKBLOODLINE' || user.isAdminEligible) ? (
                  ...
                  <div className="rounded-3xl border border-rose-500/40 bg-slate-900/90 p-6 text-center space-y-4 max-w-sm mx-auto my-8 shadow-2xl">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-rose-500/15 border border-rose-500/30 text-rose-400 mx-auto">
                    ...
                    <button
                      ...
                      className="w-full rounded-xl bg-slate-800 px-4 py-2.5 text-xs font-bold text-slate-300 hover:bg-slate-700"
                    >
                      Return to Home
                    </button>
                  </div>
